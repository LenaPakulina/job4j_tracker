...
public class SchoolTest {
    ...
    public void whenCollectClassB() {
        ...
        School school = new School();
        Predicate<Student> lowerBound = student -> student.getScore() >= 50;
        Predicate<Student> upperBound = student -> student.getScore() < 70;
        List<Student> result = school.collect(students, lowerBound.and(upperBound));
        List<Student> expected = new ArrayList<>();
